$(document).ready(function () {
    ...
    var content = [{
        ...
        title: "",
        desc: "Maybe it's a pretty simple sentence, but i really want to tell you guys."
    }, {
       title: "",
       desc: "It's not that important, but i just want to say."
    },  {
        title: "",
        desc: "Thank you for being my friend, without all of you I would be nothing"
    }, {
        title: "and thanks for everything",
        desc: "and also can you guys rate this? I'm not forcing you either, I just want to ask for your opinion so I can do better :D"
 }];
    var currentPage = 0;
    //generate content
